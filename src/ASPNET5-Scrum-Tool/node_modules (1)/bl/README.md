...
fs.createReadStream('README.md')
  .pipe(bl(function (err, data) ***REMOVED*** // note 'new' isn't strictly required
...
hyperquest(url).pipe(bl(function (err, data) ***REMOVED***
  console.log(data.toString())
***REMOVED***))
```
...
bl.duplicate().pipe(process.stdout, ***REMOVED*** end: false ***REMOVED***)
