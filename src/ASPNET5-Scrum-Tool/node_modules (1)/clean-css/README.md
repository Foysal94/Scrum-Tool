...
var source = 'a***REMOVED***font-weight:bold;***REMOVED***';
...
new CleanCSS().minify(source, function (errors, minified) ***REMOVED***
  // minified.styles
***REMOVED***);
```
...
```js
new CleanCSS(***REMOVED*** sourceMap: true, target: pathToOutputDirectory ***REMOVED***)
  .minify(source, function (minified) ***REMOVED***
...
```js
new CleanCSS(***REMOVED*** sourceMap: inputSourceMapAsString, target: pathToOutputDirectory ***REMOVED***)
  .minify(source, function (minified) ***REMOVED***
...
```js
new CleanCSS(***REMOVED*** sourceMap: true, target: pathToOutputDirectory ***REMOVED***).minify(***REMOVED***
  'path/to/source/1': ***REMOVED***
    styles: '...styles...',
    sourceMap: '...source-map...'
  ***REMOVED***,
  'path/to/source/2': ***REMOVED***
    styles: '...styles...',
    sourceMap: '...source-map...'
  ***REMOVED***
***REMOVED***, function (minified) ***REMOVED***
...
```js
new CleanCSS().minify(***REMOVED***
  'path/to/file/one': ***REMOVED***
    styles: 'contents of file one'
  ***REMOVED***,
  'path/to/file/two': ***REMOVED***
...
* `restructure` - tries to reorganize different-selector different-rules rulesets so they take less space, e.g. `.one***REMOVED***padding:0***REMOVED***.two***REMOVED***margin:0***REMOVED***.one***REMOVED***margin-bottom:3px***REMOVED***` into `.two***REMOVED***margin:0***REMOVED***.one***REMOVED***padding:0;margin-bottom:3px***REMOVED***`;
