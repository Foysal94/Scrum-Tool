...
var CleanCSS = module.exports = function CleanCSS(options) ***REMOVED***
  ...
  this.options = ***REMOVED***
    ...
    inliner: options.inliner || ***REMOVED******REMOVED***,
  ...
  ***REMOVED***;
  ...
  this.options.inliner.request = override(
    ...
    this.options.inliner.request || ***REMOVED******REMOVED***
  );
***REMOVED***;

function importOptionsFrom(rules) ***REMOVED***
  return undefined === rules ? ['all'] : rules;
***REMOVED***

function missingDirectory(filepath) ***REMOVED***
  return !fs.existsSync(filepath) && !/\.css$/.test(filepath);
***REMOVED***

function presentDirectory(filepath) ***REMOVED***
  return fs.existsSync(filepath) && fs.statSync(filepath).isDirectory();
***REMOVED***

function proxyOptionsFrom(httpProxy) ***REMOVED***
  return httpProxy ?
***REMOVED***
...
CleanCSS.prototype.minify = function (data, callback) ***REMOVED***
  var context = ***REMOVED***
  ...
  ***REMOVED***;
  ...
  if (context.options.processImport || data.indexOf('@shallow') > 0) ***REMOVED***
    // inline all imports
    var runner = callback ?
      process.nextTick :
      function (callback) ***REMOVED*** return callback(); ***REMOVED***;

    return runner(function () ***REMOVED***
      return new ImportInliner(context).process(data, ***REMOVED***
...
function runMinifier(callback, context) ***REMOVED***
  function whenSourceMapReady (data) ***REMOVED***
  ...
  ***REMOVED***
  ...
  return function (data) ***REMOVED***
    if (context.options.sourceMap) ***REMOVED***
      return context.inputSourceMapTracker.track(data, function () ***REMOVED***
        if (context.options.sourceMapInlineSources) ***REMOVED***
          return context.inputSourceMapTracker.resolveSources(function () ***REMOVED***
...
function withMetadata(context, data) ***REMOVED***
...
function minifyWithDebug(context, data) ***REMOVED***
...
function benchmark(runner) ***REMOVED***
  return function (processor, action) ***REMOVED***
...
function minify(context, data) ***REMOVED***
  ...
  var run = function (processor, action) ***REMOVED***
  ...
  ***REMOVED***;
  ...
  function restoreEscapes(data, prefixContent) ***REMOVED***
