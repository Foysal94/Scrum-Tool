...
function always() ***REMOVED***
  return true;
***REMOVED***

function backgroundImage(property1, property2, validator) ***REMOVED***
...
function border(property1, property2, validator) ***REMOVED***
...
function color(property1, property2, validator) ***REMOVED***
  // The idea here is that 'more understandable' values override 'less understandable' values, but not vice versa
...
function twoOptionalFunctions(property1, property2, validator) ***REMOVED***
...
function sameValue(property1, property2) ***REMOVED***
  var value1 = property1.value[0][0];
  var value2 = property2.value[0][0];
...
function sameFunctionOrValue(property1, property2, validator) ***REMOVED***
  var value1 = property1.value[0][0];
  var value2 = property2.value[0][0];
...
function unit(property1, property2, validator) ***REMOVED***
  // The idea here is that 'more understandable' values override 'less understandable' values, but not vice versa
  ...
  if (validator.isValidFunctionWithoutVendorPrefix(value2) && validator.isValidFunctionWithoutVendorPrefix(value1)) ***REMOVED***
    return true;
  ***REMOVED***
