...
var compactable = ***REMOVED***
  ...
  ***REMOVED***,
  'background-image': ***REMOVED***
    ...
    defaultValue: 'none'
  ***REMOVED***,
  'background-origin': ***REMOVED***
    canOverride: canOverride.always,
    defaultValue: 'padding-box',
    shortestValue: 'border-box'
  ***REMOVED***,
  'background-repeat': ***REMOVED***
    canOverride: canOverride.always,
    defaultValue: ['repeat'],
    doubleValues: true
  ***REMOVED***,
  ...
  ***REMOVED***,
  'list-style-type' : ***REMOVED***
    ...
    shortestValue: 'none'
  ***REMOVED***,
  'list-style-position' : ***REMOVED***
    canOverride: canOverride.always,
    defaultValue: 'outside',
    shortestValue: 'inside'
  ***REMOVED***,
  'list-style-image' : ***REMOVED***
    canOverride: canOverride.always,
    defaultValue: 'none'
  ***REMOVED***,
  'outline': ***REMOVED***
    ...
    shorthand: true
  ***REMOVED***,
  'outline-color': ***REMOVED***
    canOverride: canOverride.color,
    defaultValue: 'invert',
    shortestValue: 'red'
  ***REMOVED***,
  'outline-style': ***REMOVED***
    canOverride: canOverride.always,
    defaultValue: 'none'
  ***REMOVED***,
  'outline-width': ***REMOVED***
    canOverride: canOverride.unit,
    defaultValue: 'medium',
    shortestValue: '0'
  ***REMOVED***,
  '-moz-transform': ***REMOVED***
    canOverride: canOverride.sameFunctionOrValue
  ***REMOVED***,
  '-ms-transform': ***REMOVED***
    canOverride: canOverride.sameFunctionOrValue
  ***REMOVED***,
  '-webkit-transform': ***REMOVED***
    canOverride: canOverride.sameFunctionOrValue
  ***REMOVED***,
  'transform': ***REMOVED***
    canOverride: canOverride.sameFunctionOrValue
...
var addFourValueShorthand = function (prop, components, options) ***REMOVED***
  options = options || ***REMOVED******REMOVED***;
  compactable[prop] = ***REMOVED***
  ...
  ***REMOVED***;
  for (var i = 0; i < components.length; i++) ***REMOVED***
    compactable[components[i]] = ***REMOVED***
      breakUp: options.breakUp || breakUp.fourValues,
...
['', '-moz-', '-o-', '-webkit-'].forEach(function (prefix) ***REMOVED***
...
for (var property in compactable) ***REMOVED***
  if (compactable[property].shorthand) ***REMOVED***
    for (var i = 0, l = compactable[property].components.length; i < l; i++) ***REMOVED***
