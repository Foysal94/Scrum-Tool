...
function restoreImportant(property) ***REMOVED***
  property.value[property.value.length - 1][0] += IMPORTANT_TOKEN;
***REMOVED***

function restoreHack(property) ***REMOVED***
...
function restoreFromOptimizing(properties, simpleMode) ***REMOVED***
  for (var i = properties.length - 1; i >= 0; i--) ***REMOVED***
    ...
    if (!simpleMode && descriptor && descriptor.shorthand) ***REMOVED***
