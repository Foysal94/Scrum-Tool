...
function mergeMediaQueries(tokens) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  for (var name in candidates) ***REMOVED***
    ...
    positionLoop:
    for (var j = positions.length - 1; j > 0; j--) ***REMOVED***
      ...
      directionLoop:
      for (var direction = 1; direction >= -1; direction -= 2) ***REMOVED***
