...
_msvs_validators = ***REMOVED******REMOVED***
_msbuild_validators = ***REMOVED******REMOVED***


# A dictionary of settings converters. The key is the tool name, the value is
# a dictionary mapping setting names to conversion functions.
_msvs_to_msbuild_converters = ***REMOVED******REMOVED***


# Tool name mapping from MSVS to MSBuild.
_msbuild_name_of_tool = ***REMOVED******REMOVED***
...
def _AddTool(tool):
  ...
  """
  _msvs_validators[tool.msvs_name] = ***REMOVED******REMOVED***
  _msbuild_validators[tool.msbuild_name] = ***REMOVED******REMOVED***
  _msvs_to_msbuild_converters[tool.msvs_name] = ***REMOVED******REMOVED***
  _msbuild_name_of_tool[tool.msvs_name] = tool.msbuild_name


def _GetMSBuildToolSettings(msbuild_settings, tool):
  """Returns an MSBuild tool dictionary.  Creates it if needed."""
  return msbuild_settings.setdefault(tool.msbuild_name, ***REMOVED******REMOVED***)
...
def _MovedAndRenamed(tool, msvs_settings_name, msbuild_tool_name,
  ...
  def _Translate(value, msbuild_settings):
    tool_settings = msbuild_settings.setdefault(msbuild_tool_name, ***REMOVED******REMOVED***)
...
def _MSBuildOnly(tool, name, setting_type):
  ...
  def _Translate(value, msbuild_settings):
    ...
    tool_settings = msbuild_settings.setdefault(tool.msbuild_name, ***REMOVED******REMOVED***)
...
def ConvertToMSBuildSettings(msvs_settings, stderr=sys.stderr):
  ...
  """
  msbuild_settings = ***REMOVED******REMOVED***
...
_msbuild_validators[''] = ***REMOVED******REMOVED***
_msbuild_validators['ProjectReference'] = ***REMOVED******REMOVED***
_msbuild_validators['ManifestResourceCompile'] = ***REMOVED******REMOVED***
