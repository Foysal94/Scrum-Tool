...
def _GenerateTargets(data, target_list, target_dicts, toplevel_dir, files,
  ...
  name_to_target = ***REMOVED******REMOVED***
  ...
  # |files|.
  build_file_in_files = ***REMOVED******REMOVED***
...
def _WriteOutput(params, **values):
  ...
  output_path = params.get('generator_flags', ***REMOVED******REMOVED***).get(
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  try:
    ...
    if _WasGypIncludeFileModified(params, config.files):
      result_dict = ***REMOVED*** 'status': all_changed_string,
                      'test_targets': list(config.test_target_names),
                      'compile_targets': list(
                        config.additional_compile_target_names |
                        config.test_target_names) ***REMOVED***
    ...
    if not calculator.is_build_impacted():
      result_dict = ***REMOVED*** 'status': no_dependency_string,
                      'test_targets': [],
                      'compile_targets': [] ***REMOVED***
