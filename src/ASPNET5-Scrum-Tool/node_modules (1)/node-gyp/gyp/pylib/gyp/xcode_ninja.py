...
def _TargetFromSpec(old_spec, params):
  ...
  if params:
    ...
    jobs = params.get('generator_flags', ***REMOVED******REMOVED***).get('xcode_ninja_jobs', 0)

  target_name = old_spec.get('target_name')
  product_name = old_spec.get('product_name', target_name)
  product_extension = old_spec.get('product_extension')

  ninja_target = ***REMOVED******REMOVED***
  ...
  ninja_target['configurations'] = ***REMOVED******REMOVED***

  # Tell Xcode to look in |ninja_toplevel| for build products.
  new_xcode_settings = ***REMOVED******REMOVED***
  if ninja_toplevel:
  ...
  if 'configurations' in old_spec:
    for config in old_spec['configurations'].iterkeys():
      old_xcode_settings = \
        old_spec['configurations'][config].get('xcode_settings', ***REMOVED******REMOVED***)
      if 'IPHONEOS_DEPLOYMENT_TARGET' in old_xcode_settings:
        new_xcode_settings['CODE_SIGNING_REQUIRED'] = "NO"
        new_xcode_settings['IPHONEOS_DEPLOYMENT_TARGET'] = \
            old_xcode_settings['IPHONEOS_DEPLOYMENT_TARGET']
      ninja_target['configurations'][config] = ***REMOVED******REMOVED***
...
def CreateWrapper(target_list, target_dicts, data, params):
  ...
  new_target_list = []
  new_target_dicts = ***REMOVED******REMOVED***
  new_data = ***REMOVED******REMOVED***

  # Set base keys needed for |data|.
  new_data[main_gyp] = ***REMOVED******REMOVED***
  new_data[main_gyp]['included_files'] = []
  new_data[main_gyp]['targets'] = []
  new_data[main_gyp]['xcode_settings'] = \
      data[orig_gyp].get('xcode_settings', ***REMOVED******REMOVED***)
    ...
    if IsValidTargetForWrapper(target_extras, executable_target_pattern, spec):
      ...
      for old_target in data[old_qualified_target.split(':')[0]]['targets']:
        if old_target['target_name'] == target_name:
          new_data_target = ***REMOVED******REMOVED***
...
***REMOVED*** 'target_name' : sources_target_name,
      'toolset': 'target',
...
***REMOVED***, None)
  ...
  sources_target['configurations'] = ***REMOVED***'Default': ***REMOVED*** 'include_dirs': [ depth ] ***REMOVED*** ***REMOVED***
  ...
  new_data[sources_gyp] = ***REMOVED******REMOVED***
