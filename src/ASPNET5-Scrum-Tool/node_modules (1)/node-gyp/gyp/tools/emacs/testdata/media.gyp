...
***REMOVED***
      ...
      'direct_dependent_settings': ***REMOVED***
        'include_dirs': [
          '..',
        ],
  ***REMOVED***,
...
***REMOVED***],
        ...
        ['OS == "android"', ***REMOVED***
          ...
          'link_settings': ***REMOVED***
            'libraries': [
              '-lOpenSLES',
            ],
  ***REMOVED***,
***REMOVED***],
        ['OS=="linux" or OS=="freebsd" or OS=="solaris"', ***REMOVED***
          'link_settings': ***REMOVED***
            'libraries': [
              '-lasound',
            ],
...
***REMOVED***, ***REMOVED***  # else: use_cras == 0
              'sources!': [
                'audio/linux/cras_output.cc',
                'audio/linux/cras_output.h',
              ],
...
***REMOVED***, ***REMOVED***  # else: use_pulseaudio == 0
              'sources!': [
                'audio/pulse/pulse_output.cc',
                'audio/pulse/pulse_output.h',
              ],
...
***REMOVED***],
        ['os_posix == 1 and OS != "android"', ***REMOVED***
...
***REMOVED***],
        ['proprietary_codecs==1 or branding=="Chrome"', ***REMOVED***
          'sources': [
            'mp4/avc.cc',
            'mp4/avc.h',
...
***REMOVED***
      ...
      'conditions': [
        ['order_profiling != 0', ***REMOVED***
          'target_conditions' : [
            ['_toolset=="target"', ***REMOVED***
              'cflags!': [ '-finstrument-functions' ],
***REMOVED***],
          ],
***REMOVED***],
        [ 'target_arch == "ia32" or target_arch == "x64"', ***REMOVED***
          'dependencies': [
...
***REMOVED***],
        [ 'os_posix == 1 and OS != "mac" and OS != "android"', ***REMOVED***
          'cflags': [
            '-msse2',
          ],
***REMOVED***],
...
***REMOVED***],
    ['OS == "win" or toolkit_uses_gtk == 1', ***REMOVED***
      'targets': [
***REMOVED***
...
***REMOVED***],
    ['OS == "linux" and target_arch != "arm"', ***REMOVED***
      'targets': [
***REMOVED***
