...
function processRelease (argv, gyp, defaultVersion, defaultRelease) ***REMOVED***
  ...
  if (!versionSemver) ***REMOVED***
    // not a valid semver string, nothing we can do
    return ***REMOVED*** version: version ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (defaultRelease && defaultRelease.headersUrl && !overrideDistUrl) ***REMOVED***
...
function normalizePath (p) ***REMOVED***
  return path.normalize(p).replace(/\\/g, '/')
***REMOVED***

function resolveLibUrl (name, defaultUrl, arch, versionMajor) ***REMOVED***
  var base = url.resolve(defaultUrl, './')
    , hasLibUrl = bitsre.test(defaultUrl) || (versionMajor === 3 && bitsreV3.test(defaultUrl))

  if (!hasLibUrl) ***REMOVED***
