...
test('test process release - process.version = 0.8.20', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v0.8.20', null)

  t.equal(release.semver.version, '0.8.20')
  delete release.semver

  t.deepEqual(release, ***REMOVED***
    version: '0.8.20',
    name: 'node',
...
test('test process release - process.version = 0.10.21', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v0.10.21', null)
...
test('test process release - process.version = 0.12.22', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v0.12.22', null)
...
test('test process release - process.release ~ node@4.1.23', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v4.1.23', ***REMOVED***
    name: 'node',
...
test('test process release - process.release ~ node@4.1.23 / corp build', function (t) ***REMOVED***
  t.plan(2)
...
test('test process release - process.version = 1.8.4', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v1.8.4', null)
...
test('test process release - process.release ~ iojs@3.2.24', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v3.2.24', ***REMOVED***
    name: 'io.js',
...
test('test process release - process.release ~ iojs@3.2.11 +libUrl32', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v3.2.11', ***REMOVED***
    name: 'io.js',
...
test('test process release - process.release ~ iojs@3.2.101 +libUrl64', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v3.2.101', ***REMOVED***
    name: 'io.js',
...
test('test process release - process.release ~ iojs@3.3.0 - borked win-ia32', function (t) ***REMOVED***
  t.plan(2)
...
test('test process release - process.release ~ node@4.1.23 --target=0.10.40', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED*** target: '0.10.40' ***REMOVED*** ***REMOVED***, 'v4.1.23', ***REMOVED***
    name: 'node',
    headersUrl: 'https://nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz'
  ***REMOVED***)
...
test('test process release - process.release ~ node@4.1.23 --target=1.8.4', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED*** target: '1.8.4' ***REMOVED*** ***REMOVED***, 'v4.1.23', ***REMOVED***
    name: 'node',
    headersUrl: 'https://nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz'
  ***REMOVED***)
...
test('test process release - process.release ~ node@4.1.23 --dist-url=https://foo.bar/baz', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED*** 'dist-url': 'https://foo.bar/baz' ***REMOVED*** ***REMOVED***, 'v4.1.23', ***REMOVED***
    name: 'node',
    headersUrl: 'https://nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz'
  ***REMOVED***)
...
test('test process release - process.release ~ frankenstein@4.1.23', function (t) ***REMOVED***
  t.plan(2)
...
test('test process release - process.release ~ frankenstein@4.1.23 --dist-url=http://foo.bar/baz/', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED*** 'dist-url': 'http://foo.bar/baz/' ***REMOVED*** ***REMOVED***, 'v4.1.23', ***REMOVED***
    name: 'frankenstein',
...
test('test process release - process.release ~ node@4.0.0-rc.4', function (t) ***REMOVED***
  t.plan(2)

  var release = processRelease([], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v4.0.0-rc.4', ***REMOVED***
    name: 'node',
...
test('test process release - process.release ~ node@4.0.0-rc.4 passed as argv[0]', function (t) ***REMOVED***
  t.plan(2)

  // note the missing 'v' on the arg, it should normalise when checking
  // whether we're on the default or not
  var release = processRelease([ '4.0.0-rc.4' ], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v4.0.0-rc.4', ***REMOVED***
    name: 'node',
    headersUrl: 'https://nodejs.org/download/rc/v4.0.0-rc.4/node-v4.0.0-rc.4-headers.tar.gz'
  ***REMOVED***)
...
test('test process release - process.release ~ node@4.0.0-rc.4 - bogus string passed as argv[0]', function (t) ***REMOVED***
  t.plan(2)
  ...
  var release = processRelease([ 'this is no version!' ], ***REMOVED*** opts: ***REMOVED******REMOVED*** ***REMOVED***, 'v4.0.0-rc.4', ***REMOVED***
    name: 'node',
    headersUrl: 'https://nodejs.org/download/rc/v4.0.0-rc.4/node-v4.0.0-rc.4-headers.tar.gz'
  ***REMOVED***)
