...
class CustomFunctionBridge : public CallbackBridge<Sass_Value*> ***REMOVED***
  public:
    CustomFunctionBridge(v8::Local<v8::Function> cb, bool is_sync) : CallbackBridge<Sass_Value*>(cb, is_sync) ***REMOVED******REMOVED***
