...
class CustomImporterBridge : public CallbackBridge<SassImportList> ***REMOVED***
  public:
    CustomImporterBridge(v8::Local<v8::Function> cb, bool is_sync) : CallbackBridge<SassImportList>(cb, is_sync) ***REMOVED******REMOVED***
