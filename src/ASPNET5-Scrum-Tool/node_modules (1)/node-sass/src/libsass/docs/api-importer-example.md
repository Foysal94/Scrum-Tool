...
***REMOVED***
  ...
  const char* local = "local ***REMOVED*** color: green; ***REMOVED***";
  const char* remote = "remote ***REMOVED*** color: red; ***REMOVED***";
...
```C
Sass_Import_List importer(const char* path, Sass_Importer_Entry cb, struct Sass_Compiler* comp) ***REMOVED***
