...
namespace Sass ***REMOVED***
  namespace Constants ***REMOVED***
    ...
    extern const char hash_lbrace[]     = "#***REMOVED***";
    extern const char rbrace[]          = "***REMOVED***";
    ...
    extern const char uri_chars[]  = ":;/?!%&#@|[]***REMOVED******REMOVED***'`^\"*+-.,_=~";
    ...
    extern const char selector_list_delims[] = ")***REMOVED******REMOVED***;!";
    extern const char complex_selector_delims[] = ",)***REMOVED******REMOVED***;!";
    ...
    extern const unsigned char utf_8_bom[]      = ***REMOVED*** 0xEF, 0xBB, 0xBF ***REMOVED***;
    extern const unsigned char utf_16_bom_be[]  = ***REMOVED*** 0xFE, 0xFF ***REMOVED***;
    extern const unsigned char utf_16_bom_le[]  = ***REMOVED*** 0xFF, 0xFE ***REMOVED***;
    extern const unsigned char utf_32_bom_be[]  = ***REMOVED*** 0x00, 0x00, 0xFE, 0xFF ***REMOVED***;
    extern const unsigned char utf_32_bom_le[]  = ***REMOVED*** 0xFF, 0xFE, 0x00, 0x00 ***REMOVED***;
    extern const unsigned char utf_7_bom_1[]    = ***REMOVED*** 0x2B, 0x2F, 0x76, 0x38 ***REMOVED***;
    extern const unsigned char utf_7_bom_2[]    = ***REMOVED*** 0x2B, 0x2F, 0x76, 0x39 ***REMOVED***;
    extern const unsigned char utf_7_bom_3[]    = ***REMOVED*** 0x2B, 0x2F, 0x76, 0x2B ***REMOVED***;
    extern const unsigned char utf_7_bom_4[]    = ***REMOVED*** 0x2B, 0x2F, 0x76, 0x2F ***REMOVED***;
    extern const unsigned char utf_7_bom_5[]    = ***REMOVED*** 0x2B, 0x2F, 0x76, 0x38, 0x2D ***REMOVED***;
    extern const unsigned char utf_1_bom[]      = ***REMOVED*** 0xF7, 0x64, 0x4C ***REMOVED***;
    extern const unsigned char utf_ebcdic_bom[] = ***REMOVED*** 0xDD, 0x73, 0x66, 0x73 ***REMOVED***;
    extern const unsigned char scsu_bom[]       = ***REMOVED*** 0x0E, 0xFE, 0xFF ***REMOVED***;
    extern const unsigned char bocu_1_bom[]     = ***REMOVED*** 0xFB, 0xEE, 0x28 ***REMOVED***;
    extern const unsigned char gb_18030_bom[]   = ***REMOVED*** 0x84, 0x31, 0x95, 0x33 ***REMOVED***;
