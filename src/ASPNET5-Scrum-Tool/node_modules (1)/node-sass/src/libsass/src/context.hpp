...
***REMOVED*** return call_loader(load_path, ctx_path, pstate, imp, c_headers, false); ***REMOVED***;
    bool call_importers(const std::string& load_path, const char* ctx_path, ParserState& pstate, Import* imp)
***REMOVED*** return call_loader(load_path, ctx_path, pstate, imp, c_importers, true); ***REMOVED***;
  ...
  public:
    ...
    Sass_Output_Style output_style() ***REMOVED*** return c_options->output_style; ***REMOVED***;
  ...
  public:
    const std::string& cwd() ***REMOVED*** return CWD; ***REMOVED***;
  ***REMOVED***;

  class File_Context : public Context ***REMOVED***
  public:
...
***REMOVED*** ***REMOVED***
  ...
  ***REMOVED***;
  ...
  class Data_Context : public Context ***REMOVED***
  public:
    char* source_c_str;
    char* srcmap_c_str;
