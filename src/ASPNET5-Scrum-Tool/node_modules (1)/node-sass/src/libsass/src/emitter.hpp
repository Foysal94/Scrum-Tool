...
namespace Sass ***REMOVED***
  ...
  class Emitter ***REMOVED***

    public:
      Emitter(Context* ctx);
      virtual ~Emitter() ***REMOVED*** ***REMOVED***

    protected:
      OutputBuffer wbuf;
    public:
      const std::string& buffer(void) ***REMOVED*** return wbuf.buffer; ***REMOVED***
      const SourceMap smap(void) ***REMOVED*** return wbuf.smap; ***REMOVED***
      const OutputBuffer output(void) ***REMOVED*** return wbuf; ***REMOVED***
