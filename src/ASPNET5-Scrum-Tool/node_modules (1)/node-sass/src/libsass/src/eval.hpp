...
namespace Sass ***REMOVED***
  ...
  class Eval : public Operation_CRTP<Expression*, Eval> ***REMOVED***
   ...
   public:
    ...
    Type_Selector* operator()(Type_Selector* s) ***REMOVED*** return s; ***REMOVED***;
    Pseudo_Selector* operator()(Pseudo_Selector* s) ***REMOVED*** return s; ***REMOVED***;
    Wrapped_Selector* operator()(Wrapped_Selector* s) ***REMOVED*** return s; ***REMOVED***;
    Selector_Qualifier* operator()(Selector_Qualifier* s) ***REMOVED*** return s; ***REMOVED***;
    Selector_Placeholder* operator()(Selector_Placeholder* s) ***REMOVED*** return s; ***REMOVED***;
    // actual evaluated selectors
    Selector_List* operator()(Selector_Schema*);
    Expression* operator()(Parent_Selector*);

    template <typename U>
    Expression* fallback(U x) ***REMOVED*** return fallback_impl(x); ***REMOVED***
