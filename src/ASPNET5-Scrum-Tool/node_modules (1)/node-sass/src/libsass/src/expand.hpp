...
namespace Sass ***REMOVED***
  ...
  class Expand : public Operation_CRTP<Statement*, Expand> ***REMOVED***
  public:
  ...
  public:
    ...
    virtual ~Expand() ***REMOVED*** ***REMOVED***
    ...
    template <typename U>
    Statement* fallback(U x) ***REMOVED*** return fallback_impl(x); ***REMOVED***
