...
***REMOVED***
      ...
      if (path[i] && Prelexer::is_alpha(path[i])) ***REMOVED***
...
***REMOVED***
      ...
      #endif
      if (pos_p != std::string::npos && pos_w != std::string::npos) ***REMOVED***
        pos = std::max(pos_p, pos_w);
  ***REMOVED***
      else if (pos_p != std::string::npos) ***REMOVED***
        pos = pos_p;
  ***REMOVED***
      else ***REMOVED***
        pos = pos_w;
...
***REMOVED***
      ...
      size_t proto = 0;
      // check if we have a protocol
      if (path[proto] && Prelexer::is_alpha(path[proto])) ***REMOVED***
        // skip over all alphanumeric characters
        while (path[proto] && Prelexer::is_alnum(path[proto++])) ***REMOVED******REMOVED***
        // then skip over the mandatory colon
        if (proto && path[proto] == ':') ++ proto;
  ***REMOVED***

      // then skip over start slashes
      while (path[proto++] == '/') ***REMOVED******REMOVED***
...
***REMOVED***
      ...
      while ((r.length() > 3) && ((r.substr(0, 3) == "../") || (r.substr(0, 3)) == "..\\")) ***REMOVED***
        r = r.substr(3);
...
***REMOVED***
      ...
      if (rel_path.substr(0, 3) == "../") ***REMOVED***
        return orig_path;
  ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
      ...
      for (size_t i = 0; i < minSize; ++i) ***REMOVED***
  ...
  ***REMOVED***
      for (size_t i = index; i < abs_path.size(); ++i) ***REMOVED***
        stripped_uri += abs_path[i];
  ***REMOVED***
      for (size_t i = index; i < abs_base.size(); ++i) ***REMOVED***
        stripped_base += abs_base[i];
  ***REMOVED***

      size_t left = 0;
      size_t directories = 0;
      for (size_t right = 0; right < stripped_base.size(); ++right) ***REMOVED***
        if (stripped_base[right] == '/') ***REMOVED***
          if (stripped_base.substr(left, 2) != "..") ***REMOVED***
            ++directories;
  ***REMOVED***
          else if (directories > 1) ***REMOVED***
            --directories;
  ***REMOVED***
          else ***REMOVED***
            directories = 0;
...
***REMOVED***
  ***REMOVED***
      ...
      std::string result = "";
      for (size_t i = 0; i < directories; ++i) ***REMOVED***
        result += "../";
  ***REMOVED***
      result += stripped_uri;
...
***REMOVED***
      ...
      const std::vector<std::string> exts = ***REMOVED***
        ".scss", ".sass", ".css"
  ***REMOVED***;
      // split the filename
      ...
      if (file_exists(abs_path)) includes.push_back(***REMOVED******REMOVED*** rel_path, root ***REMOVED***, abs_path ***REMOVED***);
      // next test variation with underscore
      rel_path = join_paths(base, "_" + name);
      abs_path = join_paths(root, rel_path);
      if (file_exists(abs_path)) includes.push_back(***REMOVED******REMOVED*** rel_path, root ***REMOVED***, abs_path ***REMOVED***);
      // next test exts plus underscore
      for(auto ext : exts) ***REMOVED***
...
***REMOVED***
      ...
      if (path.length() > 5) ***REMOVED***
        extension = path.substr(path.length() - 5, 5);
  ***REMOVED***
      for(size_t i=0; i<extension.size();++i)
        extension[i] = tolower(extension[i]);
      if (extension == ".sass" && contents != 0) ***REMOVED***
