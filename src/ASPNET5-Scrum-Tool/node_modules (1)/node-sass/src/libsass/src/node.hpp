...
***REMOVED***;
    ...
    TYPE type() const ***REMOVED*** return mType; ***REMOVED***
    bool isCombinator() const ***REMOVED*** return mType == COMBINATOR; ***REMOVED***
    bool isSelector() const ***REMOVED*** return mType == SELECTOR; ***REMOVED***
    bool isCollection() const ***REMOVED*** return mType == COLLECTION; ***REMOVED***
    bool isNil() const ***REMOVED*** return mType == NIL; ***REMOVED***
    bool got_line_feed;

    Complex_Selector::Combinator combinator() const ***REMOVED*** return mCombinator; ***REMOVED***

    Complex_Selector* selector() ***REMOVED*** return mpSelector; ***REMOVED***
    const Complex_Selector* selector() const ***REMOVED*** return mpSelector; ***REMOVED***

    NodeDequePtr collection() ***REMOVED*** return mpCollection; ***REMOVED***
    const NodeDequePtr collection() const ***REMOVED*** return mpCollection; ***REMOVED***
    ...
    inline bool operator!=(const Node& rhs) const ***REMOVED*** return !(*this == rhs); ***REMOVED***
