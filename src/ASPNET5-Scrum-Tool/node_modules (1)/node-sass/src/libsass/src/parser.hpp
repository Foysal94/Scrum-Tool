...
namespace Sass ***REMOVED***
  ...
  class Parser : public ParserState ***REMOVED***
  public:

    enum Syntactic_Context ***REMOVED*** nothing, mixin_def, function_def ***REMOVED***;
...
***REMOVED*** in_at_root = false; stack.push_back(nothing); ***REMOVED***
