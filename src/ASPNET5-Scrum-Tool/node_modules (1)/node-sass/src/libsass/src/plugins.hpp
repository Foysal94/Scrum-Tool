...
namespace Sass ***REMOVED***
  ...
  class Plugins ***REMOVED***
    ...
    public: // public accessors
      const std::vector<Sass_Importer_Entry> get_headers(void) ***REMOVED*** return headers; ***REMOVED***
      const std::vector<Sass_Importer_Entry> get_importers(void) ***REMOVED*** return importers; ***REMOVED***
      const std::vector<Sass_Function_Entry> get_functions(void) ***REMOVED*** return functions; ***REMOVED***
