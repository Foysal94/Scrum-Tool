...
namespace Sass ***REMOVED***
  ...
  class Offset ***REMOVED***
    ...
    public:
      Offset off() ***REMOVED*** return *this; ***REMOVED***
  ...
  ***REMOVED***;
  ...
  class Position : public Offset ***REMOVED***
  ...
  ***REMOVED***;
  ...
  public:
    ...
    Token()
    : prefix(0), begin(0), end(0) ***REMOVED*** ***REMOVED***
    Token(const char* b, const char* e)
    : prefix(b), begin(b), end(e) ***REMOVED*** ***REMOVED***
    Token(const char* str)
    : prefix(str), begin(str), end(str + strlen(str)) ***REMOVED*** ***REMOVED***
    Token(const char* p, const char* b, const char* e)
    : prefix(p), begin(b), end(e) ***REMOVED*** ***REMOVED***

    size_t length()    const ***REMOVED*** return end - begin; ***REMOVED***
    std::string ws_before() const ***REMOVED*** return std::string(prefix, begin); ***REMOVED***
    std::string to_string() const ***REMOVED*** return std::string(begin, end); ***REMOVED***
    std::string time_wspace() const ***REMOVED***
      std::string str(to_string());
      std::string whitespaces(" \t\f\v\n\r");
      return str.erase(str.find_last_not_of(whitespaces)+1);
***REMOVED***

    operator bool()***REMOVED*** return begin && end && begin >= end; ***REMOVED***
    operator std::string() ***REMOVED*** return to_string(); ***REMOVED***

    bool operator==(Token t)  ***REMOVED*** return to_string() == t.to_string(); ***REMOVED***
  ***REMOVED***;

  class ParserState : public Position ***REMOVED***
    ...
    public: // down casts
      Offset off() ***REMOVED*** return *this; ***REMOVED***
      Position pos() ***REMOVED*** return *this; ***REMOVED***
      ParserState pstate() ***REMOVED*** return *this; ***REMOVED***
