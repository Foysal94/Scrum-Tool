...
namespace Sass ***REMOVED***
  ...
  */
  Node paths(const Node& arrs, Context& ctx) ***REMOVED***
    ...
    for (NodeDeque::iterator arrsIter = arrs.collection()->begin(), arrsEndIter = arrs.collection()->end();
    	arrsIter != arrsEndIter; ++arrsIter) ***REMOVED***
...
***REMOVED***
  ...
  */
  Node flatten(Node& arr, Context& ctx, int n) ***REMOVED***
    if (n != -1 && n == 0) ***REMOVED***
      return arr;
***REMOVED***
