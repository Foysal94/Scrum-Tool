...
namespace Sass ***REMOVED***
  SourceMap::SourceMap() : current_position(0, 0, 0), file("stdin") ***REMOVED*** ***REMOVED***
  SourceMap::SourceMap(const std::string& file) : current_position(0, 0, 0), file(file) ***REMOVED*** ***REMOVED***

  std::string SourceMap::render_srcmap(Context &ctx) ***REMOVED***
    ...
    if (!ctx.source_map_root.empty()) ***REMOVED***
...
***REMOVED***
    ...
    for (size_t i = 0; i < source_index.size(); ++i) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  std::string SourceMap::serialize_mappings() ***REMOVED***
    std::string result = "";
    ...
    for (size_t i = 0; i < mappings.size(); ++i) ***REMOVED***
      ...
      if (generated_line != previous_generated_line) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    for (Mapping mapping : out.smap.mappings) ***REMOVED***
      if (mapping.generated_position.line > size.line) ***REMOVED***
        throw(std::runtime_error("prepend sourcemap has illegal line"));
  ***REMOVED***
      if (mapping.generated_position.line == size.line) ***REMOVED***
        if (mapping.generated_position.column > size.column) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    if (offset.line != 0 || offset.column != 0) ***REMOVED***
      for (Mapping& mapping : mappings) ***REMOVED***
        // move stuff on the first old line
        if (mapping.generated_position.line == 0) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
***REMOVED***
    if (current_position.line == 0) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  ParserState SourceMap::remap(const ParserState& pstate) ***REMOVED***
    for (size_t i = 0; i < mappings.size(); ++i) ***REMOVED***
      if (
