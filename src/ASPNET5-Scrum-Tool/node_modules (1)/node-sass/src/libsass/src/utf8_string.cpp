...
namespace Sass ***REMOVED***
  namespace UTF_8 ***REMOVED***
    ...
    size_t code_point_count(const string& str, size_t start, size_t end) ***REMOVED***
      return utf8::distance(str.begin() + start, str.begin() + end);
***REMOVED***

    size_t code_point_count(const string& str) ***REMOVED***
      return utf8::distance(str.begin(), str.end());
***REMOVED***

    // function that will return the byte offset at a code point position
    size_t offset_at_position(const string& str, size_t position) ***REMOVED***
...
***REMOVED***
    ...
    size_t code_point_size_at_offset(const string& str, size_t offset) ***REMOVED***
...
***REMOVED***
    ...
    size_t normalize_index(int index, size_t len) ***REMOVED***
      long signed_len = static_cast<long>(len);
      // assuming the index is 1-based
      // we are returning a 0-based index
      if (index > 0 && index <= signed_len) ***REMOVED***
        // positive and within string length
        return index-1;
  ***REMOVED***
      else if (index > signed_len) ***REMOVED***
        // positive and past string length
        return len;
  ***REMOVED***
      else if (index == 0) ***REMOVED***
        return 0;
  ***REMOVED***
      else if (std::abs((double)index) <= signed_len) ***REMOVED***
