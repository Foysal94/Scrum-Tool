...
void testSemiDisjointKeys() ***REMOVED***
...
void testEmptyKeySet() ***REMOVED***
  std::cout << "testEmptyKeySet" << std::endl;
  
  //assert_raises(ArgumentError) ***REMOVED***@ssm[Set[]] = "Fail"***REMOVED***
  std::vector<std::string> s1;
  try ***REMOVED***
    ssm.put(s1, "Fail");
  ***REMOVED***
...
void testEmptyKeyGet() ***REMOVED***
  ...
  std::cout << std::endl;
***REMOVED***
void testMultipleSubsets() ***REMOVED***
  ...
  std::cout << std::endl;
***REMOVED***
void testBracketBracket() ***REMOVED***
...
void testOrderPreserved() ***REMOVED***
  ...
  std::cout << std::endl;
***REMOVED***
void testMultipleEqualValues() ***REMOVED***
...
***REMOVED***
  ...
  for (size_t i = 0, S = fetched.size(); i < S; ++i) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (size_t i = 0, S = fetched2.size(); i < S; ++i) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (size_t i = 0, S = fetched3.size(); i < S; ++i) ***REMOVED***
...
***REMOVED***
  ...
  buffer << "[";
  for (size_t i = 0, S = v.size(); i < S; ++i) ***REMOVED***
    buffer << "[" << v[i].first;
    buffer << ", Set[";
    for (size_t j = 0, S = v[i].second.size(); j < S; ++j) ***REMOVED***
      buffer << v[i].second[j];
      if (j < S-1) ***REMOVED***
        buffer << ", ";
  ***REMOVED***
...
void assertEqual(string sExpected, string sResult) ***REMOVED***
