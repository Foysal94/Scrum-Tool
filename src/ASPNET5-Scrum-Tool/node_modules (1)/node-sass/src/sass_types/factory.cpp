...
namespace SassTypes
***REMOVED***
  SassTypes::Value* Factory::create(Sass_Value* v) ***REMOVED***
    switch (sass_value_get_tag(v)) ***REMOVED***
    case SASS_NUMBER:
      return new Number(v);
...
***REMOVED***
  ***REMOVED***
  ...
  NAN_MODULE_INIT(Factory::initExports) ***REMOVED***
  ...
  ***REMOVED***
  ...
  Value* Factory::unwrap(v8::Local<v8::Value> obj) ***REMOVED***
    // Todo: non-SassValue objects could easily fall under that condition, need to be more specific.
    if (!obj->IsObject() || obj.As<v8::Object>()->InternalFieldCount() != 1) ***REMOVED***
      return NULL;
***REMOVED***
