...
***REMOVED***
  ...
  template <class T>
  class SassValueWrapper : public SassTypes::Value ***REMOVED***
    public:
      static char const* get_constructor_name() ***REMOVED*** return "SassValue"; ***REMOVED***
  ...
  ***REMOVED***;
  ...
  template <class T>
  SassValueWrapper<T>::SassValueWrapper(Sass_Value* v) ***REMOVED***
    this->value = sass_clone_value(v);
  ***REMOVED***

  template <class T>
  SassValueWrapper<T>::~SassValueWrapper() ***REMOVED***
    this->js_object.Reset();
    sass_delete_value(this->value);
  ***REMOVED***

  template <class T>
  Sass_Value* SassValueWrapper<T>::get_sass_value() ***REMOVED***
    return sass_clone_value(this->value);
  ***REMOVED***

  template <class T>
  v8::Local<v8::Object> SassValueWrapper<T>::get_js_object() ***REMOVED***
    if (this->js_object.IsEmpty()) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  template <class T>
  v8::Local<v8::FunctionTemplate> SassValueWrapper<T>::get_constructor_template() ***REMOVED***
  ...
  ***REMOVED***
  ...
  template <class T>
  v8::Local<v8::Function> SassValueWrapper<T>::get_constructor() ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
  ...
  template <class T>
  NAN_METHOD(SassValueWrapper<T>::New) ***REMOVED***
    std::vector<v8::Local<v8::Value>> localArgs(info.Length());

    for (auto i = 0; i < info.Length(); ++i) ***REMOVED***
      localArgs[i] = info[i];
***REMOVED***
    if (info.IsConstructCall()) ***REMOVED***
      Sass_Value* value;
      if (T::construct(localArgs, &value) != NULL) ***REMOVED***
        T* obj = new T(value);
...
***REMOVED*** else ***REMOVED***
      ...
      if (Nan::NewInstance(cons, info.Length(), &localArgs[0]).ToLocal(&inst)) ***REMOVED***
...
***REMOVED***
  ***REMOVED***
  ...
  template <class T>
  T* SassValueWrapper<T>::unwrap(v8::Local<v8::Object> obj) ***REMOVED***
    /* This maybe NULL */
    return static_cast<T*>(Factory::unwrap(obj));
  ***REMOVED***

  template <class T>
  Sass_Value *SassValueWrapper<T>::fail(const char *reason, Sass_Value **out) ***REMOVED***
